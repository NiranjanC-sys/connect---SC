    ...
    <div className="min-h-screen flex flex-col md:flex-row">
      ...
      >
        <div className="text-white text-center p-12 z-10">
          ...
          >
            <h1 className="text-5xl font-bold mb-6">Nebula Social</h1>
            <p className="text-xl opacity-80 mb-8">Connect with friends and the world around you in a futuristic digital space.</p>
          </motion.div>
        </div>
